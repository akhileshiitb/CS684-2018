...
* Description: This code will blink on board LED on Tiva C series board.
* onboard switch 1 is used to change delay(blinking speed) through 3 values
* onboard switch 2 is used to change the colour of the LED through red green blue in cyclic manner
* This code does not use intterupt facility(using which code would have been much simpler).
* delay used is software delay.
* I have modeled this code using state machine having 3 states for both sw1 and sw2
